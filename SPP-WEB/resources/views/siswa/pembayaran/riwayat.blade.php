...
@section('content')
    @if (!$siswa)
        <div class="card p-4" style="width: 28rem; margin: 10vh auto;">
            <h3 class="text-center">Anda Belum Pernah Melakukan Pembayaran ❌</h3>
        </div>
    @else
        <h2>Riwayat Pembayaran</h2>
        <div class="d-flex">
            <a href="/siswa/pembayaran/cetak/kartu/{{ $siswa->nisn }}" class="btn btn-secondary my-2" target="_blank">Cetak Kartu</a>
        </div>
